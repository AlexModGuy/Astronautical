...
public class CosmicChunkGenerator extends NoiseChunkGenerator<CosmicChunkSettings> {

    public CosmicChunkGenerator(IWorld worldIn, BiomeProvider biomeProviderIn, CosmicChunkSettings settingsIn) {
